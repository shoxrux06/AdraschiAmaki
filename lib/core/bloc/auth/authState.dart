  ...
  {  AuthStatus? status,
    ...
    File? avatar,}
      ...
      AuthState(
        ...
        isSendingRequestDeleteAccount: isSendingRequestDeleteAccount?? this.isSendingRequestDeleteAccount,
        isSentRequestDeleteAccount: isSentRequestDeleteAccount ?? this.isSendingRequestDeleteAccount,
        isDeletingAccount: isDeletingAccount?? this.isDeletingAccount,
        isDeletedAccount: isDeletedAccount ?? this.isDeletedAccount,
        isReseting: isReseting?? this.isReseting,
        isReseted: isReseted?? this.isReseted,
        isForgotRequestSending: isForgotRequestSending ?? this.isForgotRequestSending,
        isForgotResponseReceived: isForgotResponseReceived?? this.isForgotResponseReceived,
